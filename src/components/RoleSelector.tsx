...
export const RoleSelector: React.FC<RoleSelectorProps> = ({
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col justify-between relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 sm:py-20 flex-1 flex flex-col items-center justify-center text-center z-10 w-full">
        {/* Brand Icon Badge */}
        ...
        <p className="text-base sm:text-lg text-zinc-400 max-w-xl mx-auto font-light leading-relaxed mb-8 sm:mb-10 px-2">
          {config.slogan}. Agende seu horário com rapidez, escolha seus serviços
          e garanta seu atendimento de forma simples e rápida.
        </p>
        ...
        <div className="w-full max-w-lg mb-8">
          <button
            ...
            className="w-full group relative overflow-hidden rounded-2xl bg-gradient-to-br from-amber-500 via-amber-500 to-amber-600 p-6 sm:p-8 text-left transition-all duration-300 shadow-2xl shadow-amber-500/25 hover:shadow-amber-500/40 hover:scale-[1.02] active:scale-[0.99] border border-amber-400/50"
          >
            ...
            <p className="text-sm text-zinc-950/80 leading-relaxed font-semibold mb-6 max-w-md">
              Ver serviços, escolher data e horário disponível, e agendar seu
              atendimento em poucos segundos.
            </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 w-full max-w-lg text-xs text-zinc-400">
          <div className="p-3 bg-zinc-900/60 rounded-xl border border-zinc-800/80 flex items-center justify-center gap-2">
            ...
            <span className="truncate">
              {config.address.split("-")[0] || config.address}
            </span>
          </div>
          <div className="p-3 bg-zinc-900/60 rounded-xl border border-zinc-800/80 flex items-center justify-center gap-2">
      ...
      <div className="border-t border-zinc-900 bg-zinc-950/90 py-5 px-4 z-10">
        <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-zinc-500">
          ...
          <button
            ...
            className="group inline-flex items-center gap-1.5 text-zinc-600 hover:text-amber-400 text-[11px] font-medium transition-colors py-1 px-2 rounded-lg hover:bg-zinc-900 border border-transparent hover:border-zinc-800"
